...
int main() {
  ...
  *p = p2;
  ...
  // A proxima linha tenta acessar o espaco em memoria ja liberado.
  // C permite que isso seja feito, mas nao garante o conteudo da memoria.
  // Isso nunca deve ser feito num programa real (acessar memoria ja liberada).
  printf("Peso: %d, Altura %d.\n ", p->peso, p->altura);
