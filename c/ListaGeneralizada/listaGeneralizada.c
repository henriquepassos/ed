...
// Cria um novo no do tipo elemLista e retorna seu endereco
...
// Cria um novo no do tipo inicioLista e retorna seu endereco
...
// verifica se duas listas sao identicas
...
/* recebe o endereco do no "anterior" ao que sera inserido. O no que sera
