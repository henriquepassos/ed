...
// Nao usaremos sentinela ou cabeca nesta estrutura.
******************************************************************************/
#include <stdio.h>
#include <malloc.h>
#define true 1
...
// o ponteiro topo aponta para o topo da pilha (sera NULL caso a pilha esteja vazia)
typedef struct {
  PONT topo;
} PILHA;

/* Inicializacao da pilha ligada (a pilha jah esta criada e eh apontada
pelo endereco em l) */
void inicializarPilha(PILHA *l){
  l->topo = NULL;
} /* inicializarPilha */

/* Exibicao da pilha sequencial */
...
/* Exclusao do elemento do topo da pilha e copia deste elemento para o
   endereco apontado por reg */
...
/* Insercao em pilha (sempre no topo)
   Notem que o metodo e bool mas sempre retornara true */
