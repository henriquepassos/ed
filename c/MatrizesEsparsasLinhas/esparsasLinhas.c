/******************************************************************************
  ...
  Havera um no cabeca (que armazena a ordem da matriz).
******************************************************************************/
#include <stdio.h>
#define true 1
#define false 0
...
/* Inicializacao da matriz esparsa (cria a matriz, o cabeca e retorna o endereco
  da matriz */
...
/* Exibicao sequencial da Matriz no formato (linha, coluna : valor) */
...
/* Exclusao do elemento de posico (linha e coluna) indicados */
...
/* Destruicao da matriz libera a memoria de todos os elementos da matriz
   menos o no cabeca */
...
/* Insercao na matriz => funcionara como substituir caso o no jah exista */
