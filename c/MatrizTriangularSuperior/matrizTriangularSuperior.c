...
/* Inicializacao da matriz triangluar (aloca memoria para o arranjo, apontado
...
/* Exibicao bidimensional da matriz                                         */
...
/* Insercao na matriz => funcionara como substituir caso o valor jah exista */
